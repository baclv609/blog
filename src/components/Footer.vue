        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than
                        100 countries & 5 million customers. Have any query ?</p>
                    <a href="javascript:;"
                        class="no-underline py-2.5 px-5 h-9 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                        Contact us
                    </a>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="list-none p-0 text-sm transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"
                                class=" no-underline text-gray-600 hover:text-gray-900">Home</a></li>
                        <li class="mb-6"><a href="javascript:;"
                                class=" no-underline  text-gray-600 hover:text-gray-900">About</a></li>
                        <li><a href="javascript:;" class=" no-underline  text-gray-600 hover:text-gray-900">Pricing</a>
                        </li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="list-none p-0 text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"
                                class=" no-underline text-gray-600 hover:text-gray-900">Figma UI System</a></li>
                        <li class="mb-6"><a href="javascript:;"
                                class=" no-underline  text-gray-600 hover:text-gray-900">Icons Assets</a></li>
                        <li><a href="javascript:;" class=" no-underline  text-gray-600 hover:text-gray-900">Responsive
                                Blocks</a></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="list-none p-0 text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"
                                class=" no-underline text-gray-600 hover:text-gray-900">Customer Support</a></li>
                        <li class="mb-6"><a href="javascript:;"
                                class=" no-underline  text-gray-600 hover:text-gray-900">Terms & Conditions</a></li>
                        <li><a href="javascript:;" class=" no-underline  text-gray-600 hover:text-gray-900">Privacy
                                Policy</a></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left ">
                    ...
                    <a href="javascript:;"
                        class=" no-underline flex items-center justify-center gap-2 border border-indigo-600 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-indigo-600 font-semibold transition-all duration-500 hover:bg-indigo-50">Subscribe<svg
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">pagedone</a> 2024, All
                        rights reserved.</span>
                    <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="javascript:;"
                            class=" no-underline w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-gray-900">
                        ...
                        <a href="javascript:;" class=" no-underline relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                            ">
                        ...
                        <a href="javascript:;"
                            class=" no-underline relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                        ...
                        <a href="javascript:;"
                            class=" no-underline relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
