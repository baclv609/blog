    ...
    <div class="flex justify-center items-center h-[100vh]">
        <div
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <div class="mt-6">
                    <button
                        class="boder-gray w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
                        Đăng nhập
                    </button>
                </div>
